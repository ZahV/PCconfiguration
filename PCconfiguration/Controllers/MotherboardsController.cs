...
namespace PCconfiguration.Controllers
{
    public class MotherboardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] Motherboard motherboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] Motherboard motherboard)
        {
