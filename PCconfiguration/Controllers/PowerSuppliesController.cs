...
namespace PCconfiguration.Controllers
{
    public class PowerSuppliesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] PowerSupply powerSupply)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] PowerSupply powerSupply)
        {
