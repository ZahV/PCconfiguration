...
namespace PCconfiguration.Controllers
{
    public class HardDrivesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] HardDrive hardDrive)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] HardDrive hardDrive)
        {
            if (id != hardDrive.Id)
            {
                return NotFound();
